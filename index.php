...
$xoopsTpl->assign('bookmarklet',"javascript:if(document.getElementById('tagmemo_scr'))document.body.removeChild(document.getElementById('tagmemo_scr'));(function(){var s=document.createElement('script');s.id='tagmemo_s';s.charset='EUC-JP';s.src='".XOOPS_URL."/modules/tagmemo/quickform.php?uname=".rawurlencode($uname)."';document.body.appendChild(s)})();");
