function createTagmemoQuickForm() {
	try {
		...
		var win;
		win = new Window('tagmemo_qe_container', {top:100, right:100, width:300, height:250, zIndex:150, opacity:0.95, resizable: true, fixed: true, title: title, footer: ":: tagmemo ::", url: tagmemo_quickurl});
		win.show();
		return true;
